...
class TestSceneSaveLoadRoundTrip:
    ...
    def test_save_load_preserves_zoomlevel_for_non_default_size_image(self, temp_tilestore, test_images, tmp_path):
        """
    ...
    def test_save_load_preserves_zoomlevel_for_default_size_image(self, temp_tilestore, test_images, tmp_path):
        """
    ...
    def test_save_load_multiple_objects_preserves_all_properties(self, temp_tilestore, test_images, tmp_path):
        """
    ...
    def test_save_load_preserves_scene_properties(self, temp_tilestore, test_images, tmp_path):
        """
    ...
    def test_negative_zoomlevel_preserved(self, temp_tilestore, test_images, tmp_path):
        """
