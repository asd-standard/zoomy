...
def _get_logger() -> Any:
    ...
    -------
    Any
        Logger instance for TileStore module
    """
    global __logger
    if __logger is None:
...
def get_media_path(media_id: str) -> str:
    ...
    -------
    str
        Path to the directory containing tiles for the media
    """
...
def get_metadata(media_id: str, key: str) -> Optional[Any]:
    ...
    -------
    Optional[Any]
        Value associated with the metadata key, or None if not found
    """
...
def tiled(media_id: str) -> bool:
    ...
    -------
    bool
        True if media has been tiled, False otherwise
    """
...
def get_tilestore_stats() -> Dict[str, Any]:
    ...
    -------
    Dict[str, Any]
        Dictionary containing stats (total_size, file_count, media_count, total_size_mb)
    """
    logger = _get_logger()
    stats = {
        'total_size': 0,
...
def auto_cleanup(max_age_days: int = 3, enable: bool = True) -> Optional[Dict[str, Any]]:
    ...
    Optional[Dict[str, Any]]
        Cleanup statistics or None if disabled
    """
    logger = _get_logger()
